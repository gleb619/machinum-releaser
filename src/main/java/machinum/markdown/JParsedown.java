...
public class JParsedown {
    ...
    protected static HashSet<String> textLevelElements = new HashSet<>(Arrays.asList("a", "br", "bdo", "abbr", "blink", "nextid", "acronym", "basefont",
    ...
    protected String generateHeaderId(String text, int level) {
        ...
        headerId = URLEncoder.encode(headerId, StandardCharsets.UTF_8);
